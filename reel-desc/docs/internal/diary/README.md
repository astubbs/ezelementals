...
Per [`AGENTS.md`](../../../AGENTS.md), entries get written for:
...
- **Interesting discoveries.** Non-obvious technical findings,
  protocol quirks, library bugs, CI surprises, UX insights that
  future us would want to know the *why* for.
...
- [`2026-04-17-studio-tests-and-ci.md`](2026-04-17-studio-tests-and-ci.md)
  Studio UI testing layered from smoke to acceptance to real E2E;
  CI built out in parallel with coverage, Dependabot, duplicate
  code detection, dependency vulnerability review, and stacked PR
  dependency checks. Surfaced a real Pillow CVE and cleared
