...
**Current status:** Pivoting from ezElementals (4D effects only) to the broader ReelDesc architecture — [see plan](docs/internal/pivot-semantic-media-database.md).
